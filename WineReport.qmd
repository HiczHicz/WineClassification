...
Celem niniejszego raportu jest podsumowanie trzech modeli klasyfikacyjnych utworzonych na podstawie danych *Wine recognition data*[^1], zawierającego 13 parametrów fizykochemicznych win powstałych z trzech typów winogron w tym samym regionie Włoch.
...
Prace nad modelem poprzedzono analizą danych, w celu głębszego poznania ich struktury. W ramach analizy zrealizowano następujące kroki:

-   **Weryfikacja braków danych:** Sprawdzono kompletność zbioru, aby uniknąć błędów w działaniu algorytmów.

-   **Analiza zmiennej celu:** Zweryfikowano stopień zrównoważenia klas, co jest kluczowe dla wyboru odpowiednich miar oceny modeli.
...
3.  **Badanie rozkładów zmiennych.** Można na ich podstawie wyznaczyć parametry, które izolują dane klasy:
...
3.  **Badanie rozkładów i wartości odstających.**
